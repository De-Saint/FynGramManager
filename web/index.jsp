<%-- 
    Document   : index
    Created on : Jun 18, 2020, 2:04:11 PM
    Author     : Pinky
--%>
...
<body class="app h-100vh">
    <!-- Loader -->
    <jsp:include page="pages/general/login/login.jsp"></jsp:include>
    ...
    <script src="pages/general/login/login.js" type="text/javascript"></script>
