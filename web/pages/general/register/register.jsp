...
<html dir="ltr" lang="en">
    ...
    <body class="app h-100vh">
        ...
        <jsp:include page="../../../WEB-INF/static_pages/general/register/register.jsp"></jsp:include>
        ...
        <script src="../../../assets/plugins/accordion/jquery.accordion-wizard.min.js"></script>
