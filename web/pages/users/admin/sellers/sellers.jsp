<%-- 
    Document   : sellers
    Created on : Jun 15, 2020, 10:17:19 PM
    Author     : Pinky
--%>
...
<html dir="ltr" lang="en">
    ...
    <head>
        ...
        <title>FynGram Manager :: Sellers</title>
        <!-- Bootstrap css -->
        ...
        <link href="sellers.css" rel="stylesheet" type="text/css"/>
    ...
    <body class="app sidebar-mini">
        <jsp:include page="../../../../WEB-INF/static_pages/users/admin/sellers/sellers.jsp"></jsp:include>
