<%-- 
    ...
    Created on : Jun 22, 2020, 10:10:25 AM
    Author     : mac
--%>
...
<html dir="ltr" lang="en">
    ...
    <head>
        ...
        <title>FynGram Manager :: Seller :: Details</title>
        <!-- Bootstrap css -->
    ...
    <body class="app sidebar-mini">
        <jsp:include page="../../../../WEB-INF/static_pages/users/admin/sellers/sellerdetails.jsp"></jsp:include>
