<%-- 
    Document   : discount
    Created on : Jun 15, 2020, 10:07:01 PM
    Author     : Pinky
--%>
...
<html dir="ltr" lang="en">
    ...
    <head>
        ...
        <title>FynGram Manager :: Discount</title>
        <!-- Bootstrap css -->
    ...
    <body class="app sidebar-mini">
        ...
        <jsp:include page="../../../../WEB-INF/static_pages/users/admin/discount/discount.jsp"></jsp:include>
        ...
        <script src="../../../../assets/plugins/sidebar/sidebar.js"></script>Ï
        <script src="../../../../assets/plugins/scroll-bar/jquery.mCustomScrollbar.concat.min.js"></script>
