<%-- 
    Document   : newdiscountcode
    Created on : Jun 28, 2020, 11:33:45 AM
    Author     : Pinky
--%>
...
<html dir="ltr" lang="en">
    ...
    <head>
        ...
        <title>FynGram Manager :: New :: Discount Code</title>
        <!-- Bootstrap css -->
    ...
    <body class="app sidebar-mini">
        ...
        <jsp:include page="../../../../WEB-INF/static_pages/users/admin/discount/newdiscountcode.jsp"></jsp:include>
