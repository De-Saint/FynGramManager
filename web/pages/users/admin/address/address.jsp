<%-- 
    Document   : adrress
    Created on : Jun 15, 2020, 10:29:32 PM
    Author     : Pinky
--%>
...
<html dir="ltr" lang="en">
    ...
    <head>
        ...
        <title>FynGram Manager :: Address Types</title>
        <!-- Bootstrap css -->
    ...
    <body class="app sidebar-mini">
        ...
        <jsp:include page="../../../../WEB-INF/static_pages/users/admin/address/address.jsp"></jsp:include>
