<%-- 
    Document   : guests
    Created on : Jun 21, 2020, 5:10:37 PM
    Author     : mac
--%>
...
<html dir="ltr" lang="en">
    ...
    <head>
        ...
        <title>FynGram Manager :: Guests/Visitors</title>
        <!-- Bootstrap css -->
    ...
    <body class="app sidebar-mini">
        ...
        <jsp:include page="../../../../WEB-INF/static_pages/users/admin/guests/guests.jsp"></jsp:include>
        ...
        <script src="guests.js" type="text/javascript"></script>
