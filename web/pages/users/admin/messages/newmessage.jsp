<%-- 
    Document   : newmessage
    Created on : Jun 22, 2020, 7:41:15 PM
    Author     : mac
--%>
...
<html dir="ltr" lang="en">
    ...
    <head>
        ...
        <title>FynGram Manager :: New :: Message</title>
        <!-- Bootstrap css -->
    ...
    <body class="app sidebar-mini">
        ...
        <jsp:include page="../../../../WEB-INF/static_pages/users/admin/messages/newmessage.jsp"></jsp:include>
