<%-- 
    Document   : complaints
    Created on : Jun 21, 2020, 5:12:34 PM
    Author     : mac
--%>
...
<html dir="ltr" lang="en">
    ...
    <head>
        ...
        <title>FynGram Manager :: Complaints</title>
        <!-- Bootstrap css -->
    ...
    <body class="app sidebar-mini">
        ...
        <jsp:include page="../../../../WEB-INF/static_pages/users/admin/complaints/complaints.jsp"></jsp:include>
        ...
        <script src="complaints.js" type="text/javascript"></script>
