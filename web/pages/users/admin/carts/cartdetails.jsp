<%-- 
    ...
    Created on : Jun 22, 2020, 6:38:59 AM
    Author     : mac
--%>
...
<html dir="ltr" lang="en">
    ...
    <head>
        ...
        <title>FynGram Manager :: Cart :: Details</title>
        <!-- Bootstrap css -->
    ...
    <body class="app sidebar-mini">
        ...
        <jsp:include page="../../../../WEB-INF/static_pages/users/admin/carts/cartdetails.jsp"></jsp:include>
        ...
        <script src="cartdetails.js" type="text/javascript"></script>
