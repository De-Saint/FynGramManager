<%-- 
    Document   : carts
    Created on : Jun 21, 2020, 4:58:59 PM
    Author     : mac
--%>
...
<html dir="ltr" lang="en">
    ...
    <head>
        ...
        <title>FynGram Manager :: Cart</title>
        <!-- Bootstrap css -->
    ...
    <body class="app sidebar-mini">
        ...
        <jsp:include page="../../../../WEB-INF/static_pages/users/admin/carts/carts.jsp"></jsp:include>
        ...
        <script src="carts.js" type="text/javascript"></script>
