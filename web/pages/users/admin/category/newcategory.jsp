<%-- 
    ...
    Created on : Jun 21, 2020, 7:24:29 PM
    Author     : mac
--%>
...
<html dir="ltr" lang="en">
    ...
    <head>
        ...
        <title>FynGram Manager :: New :: Category</title>
        <!-- Bootstrap css -->
    ...
    <body class="app sidebar-mini">
        ...
        <jsp:include page="../../../../WEB-INF/static_pages/users/admin/category/newcategory.jsp"></jsp:include>
     ...
     <script src="../../../../assets/plugins/notify/js/notifIt.js"></script>
        ...
        <script src="newcategory.js" type="text/javascript"></script>
