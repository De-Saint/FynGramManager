<%-- 
    Document   : category
    Created on : Jun 15, 2020, 10:03:21 PM
    Author     : Pinky
--%>
...
<html dir="ltr" lang="en">
    ...
    <head>
        ...
        <title>FynGram Manager :: Category</title>
        <!-- Bootstrap css -->
    ...
    <body class="app sidebar-mini">
        <jsp:include page="../../../../WEB-INF/static_pages/users/admin/category/category.jsp"></jsp:include>
