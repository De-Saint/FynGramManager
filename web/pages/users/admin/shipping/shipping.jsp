<%-- 
    Document   : shipping
    Created on : Jun 15, 2020, 10:18:18 PM
    Author     : Pinky
--%>
...
<html dir="ltr" lang="en">
    ...
    <head>
        ...
        <title>FynGram Manager :: Shipping</title>
        <!-- Bootstrap css -->
        ...
        <link href="shipping.css" rel="stylesheet" type="text/css"/>
    ...
    <body class="app sidebar-mini">
        ...
        <jsp:include page="../../../../WEB-INF/static_pages/users/admin/shipping/shipping.jsp"></jsp:include>
