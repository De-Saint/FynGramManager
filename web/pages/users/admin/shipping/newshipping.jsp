<%-- 
    Document   : newshipping
    Created on : Jun 24, 2020, 1:18:45 PM
    Author     : Pinky
--%>
...
<html dir="ltr" lang="en">
    ...
    <head>
        ...
        <title>FynGram Manager :: New :: Shipping</title>
        <!-- Bootstrap css -->
    ...
    <body class="app sidebar-mini">
        ...
        <jsp:include page="../../../../WEB-INF/static_pages/users/admin/shipping/newshipping.jsp"></jsp:include>
        ...
        <script src="newshipping.js" type="text/javascript"></script>
