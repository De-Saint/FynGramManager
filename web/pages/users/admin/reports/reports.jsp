<%-- 
    Document   : reports
    Created on : Jun 15, 2020, 10:13:20 PM
    Author     : Pinky
--%>
...
<html dir="ltr" lang="en">
    ...
    <head>
        ...
        <title>FynGram Manager :: Statistics</title>
        <!-- Bootstrap css -->
    ...
    <body class="app sidebar-mini">
        <jsp:include page="../../../../WEB-INF/static_pages/users/admin/reports/reports.jsp"></jsp:include>
