<%-- 
    Document   : newpickup
    Created on : Jun 22, 2020, 1:14:46 PM
    Author     : mac
--%>
...
<html dir="ltr" lang="en">
    ...
    <head>
        ...
        <title>FynGram Manager :: New :: Pickup Station</title>
        <!-- Bootstrap css -->
    ...
    <body class="app sidebar-mini">
        ...
        <jsp:include page="../../../../WEB-INF/static_pages/users/admin/pickup/newpickup.jsp"></jsp:include>
        ...
        <script src="pickup.js" type="text/javascript"></script>
