<%-- 
    Document   : pickup
    Created on : Jun 15, 2020, 10:10:39 PM
    Author     : Pinky
--%>
...
<html dir="ltr" lang="en">
    ...
    <head>
        ...
        <title>FynGram Manager :: Pickup Stations</title>
        <!-- Bootstrap css -->
    ...
    <body class="app sidebar-mini">
        ...
        <jsp:include page="../../../../WEB-INF/static_pages/users/admin/pickup/pickup.jsp"></jsp:include>
