<%-- 
    ...
    Created on : Jun 21, 2020, 5:24:36 PM
    Author     : mac
--%>
...
<html dir="ltr" lang="en">
    ...
    <head>
        ...
        <title>FynGram Manager :: New Features</title>
        <!-- Bootstrap css -->
    ...
    <body class="app sidebar-mini">
        ...
        <jsp:include page="../../../../WEB-INF/static_pages/users/admin/newfeatures/newfeatures.jsp"></jsp:include>
        ...
        <script src="newfeatures.js" type="text/javascript"></script>
