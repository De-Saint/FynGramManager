<%-- 
    ...
    Created on : Jun 22, 2020, 10:07:16 AM
    Author     : mac
--%>
...
<html dir="ltr" lang="en">
    ...
    <head>
        ...
        <title>FynGram Manager :: Customer :: Details</title>
        <!-- Bootstrap css -->
    ...
    <body class="app sidebar-mini">
        ...
        <jsp:include page="../../../../WEB-INF/static_pages/users/admin/customers/customerdetails.jsp"></jsp:include>
