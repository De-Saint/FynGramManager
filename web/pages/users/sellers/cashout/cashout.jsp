<%-- 
    Document   : cashout
    Created on : Jun 15, 2020, 10:01:53 PM
    Author     : Pinky
--%>
...
<html dir="ltr" lang="en">
    ...
    <body class="app sidebar-mini">
        ...
        <jsp:include page="../../../../WEB-INF/static_pages/users/sellers/cashout/cashout.jsp"></jsp:include>
        ...
        <script src="../../../../assets/js/appscripts/cashout.js" type="text/javascript"></script>
