<%-- 
    Document   : wallet
    Created on : Jun 15, 2020, 10:21:31 PM
    Author     : Pinky
--%>
...
<html dir="ltr" lang="en">
    ...
    <head>
        ...
        <title>FynGram Manager :: Wallet</title>
        <!-- Bootstrap css -->
    ...
    <body class="app sidebar-mini">
        ...
        <jsp:include page="../../../../WEB-INF/static_pages/users/sellers/wallet/wallet.jsp"></jsp:include>
        ...
        <script src="../../../../assets/js/appscripts/wallet.js"></script>
