<%-- 
    Document   : stock
    Created on : Jun 15, 2020, 10:19:24 PM
    Author     : Pinky
--%>
...
<html dir="ltr" lang="en">
    ...
    <head>
        ...
        <title>FynGram Manager :: Stock Management</title>
        <!-- Bootstrap css -->
        ...
        <link href="../../../../assets/plugins/sweet-alert/sweetalert.css" rel="stylesheet"><!-- Nice-select css  -->
        <!-- Color-palette css-->
    ...
    <body class="app sidebar-mini">
        ...
        <jsp:include page="../../../../WEB-INF/static_pages/users/sellers/stock/stock.jsp"></jsp:include>
        ...
        <script src="../../../../assets/js/appscripts/stock.js" ></script>
