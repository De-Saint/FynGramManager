<%-- 
    Document   : payment
    Created on : Jun 15, 2020, 10:09:29 PM
    Author     : Pinky
--%>
...
<html dir="ltr" lang="en">
    ...
    <head>
        ...
        <title>FynGram Manager :: Payments</title>
        <!-- Bootstrap css -->
    ...
    <body class="app sidebar-mini">
        ...
        <jsp:include page="../../../../WEB-INF/static_pages/users/sellers/payment/payment.jsp"></jsp:include>
        ...
        <script src="../../../../assets/js/appscripts/payment.js" type="text/javascript"></script>
