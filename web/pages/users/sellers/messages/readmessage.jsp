<%-- 
    ...
    Created on : Jun 22, 2020, 7:39:49 PM
    Author     : mac
--%>
...
<html dir="ltr" lang="en">
    ...
    <head>
        ...
        <title>FynGram Manager :: Read Message</title>
        <!-- Bootstrap css -->
    ...
    <body class="app sidebar-mini">
        ...
        <jsp:include page="../../../../WEB-INF/static_pages/users/sellers/messages/readmessage.jsp"></jsp:include>
