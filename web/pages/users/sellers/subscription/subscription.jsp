<%-- 
    ...
    Created on : Jun 22, 2020, 4:53:51 PM
    Author     : mac
--%>
...
<html dir="ltr" lang="en">
    ...
    <head>
        ...
        <title>FynGram Manager :: Subscriptions</title>
        <!-- Bootstrap css -->
    ...
    <body class="app sidebar-mini">
        <!-- End Switcher -->
        <!-- Loader -->
        <jsp:include page="../../../../WEB-INF/static_pages/users/sellers/subscription/subscription.jsp"></jsp:include>
        ...
        <script src="../../../../assets/js/appscripts/subscription.js" ></script>
