<%-- 
    Document   : reviews
    Created on : Jun 15, 2020, 10:15:48 PM
    Author     : Pinky
--%>
...
<html dir="ltr" lang="en">
    ...
    <head>
        ...
        <title>FynGram Manager :: Reviews</title>
        <!-- Bootstrap css -->
    ...
    <body class="app sidebar-mini">
        <jsp:include page="../../../../WEB-INF/static_pages/users/sellers/reviews/reviews.jsp"></jsp:include>
        ...
        <script src="../../../../assets/js/appscripts/reviews.js"></script>
