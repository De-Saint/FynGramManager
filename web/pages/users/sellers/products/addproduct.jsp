<%-- 
    Document   : addproduct
    Created on : Jun 22, 2020, 5:28:23 AM
    Author     : mac
--%>
...
<html dir="ltr" lang="en">
    ...
    <head>
        ...
        <title>FynGram Manager :: Add :: Product</title>
        <!-- Bootstrap css -->
    ...
    <body class="app sidebar-mini">
        ...
        <jsp:include page="../../../../WEB-INF/static_pages/users/sellers/products/addproduct.jsp"></jsp:include>
	...
	<script src="../../../../assets/plugins/fancy-file-uploader/jquery.fancy-fileupload.js"></script>
        ...
        <script src="../../../../assets/js/appscripts/addproduct.js"></script>
    </body>
