<%-- 
    Document   : products
    Created on : Jun 15, 2020, 10:11:18 PM
    Author     : Pinky
--%>
...
<html dir="ltr" lang="en">
    ...
    <head>
        ...
        <title>FynGram Manager :: Products</title>
        <!-- Bootstrap css -->
    ...
    <body class="app sidebar-mini">
        ...
        <jsp:include page="../../../../WEB-INF/static_pages/users/sellers/products/products.jsp"></jsp:include>
