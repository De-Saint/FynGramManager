<%-- 
    ...
    Created on : Jun 22, 2020, 6:07:20 AM
    Author     : mac
--%>
...
<html dir="ltr" lang="en">
    ...
    <head>
        ...
        <title>FynGram Manager :: Product :: Details</title>
        <!-- Bootstrap css -->
    ...
    <body class="app sidebar-mini">
        ...
        <jsp:include page="../../../../WEB-INF/static_pages/users/sellers/products/productdetails.jsp"></jsp:include>
