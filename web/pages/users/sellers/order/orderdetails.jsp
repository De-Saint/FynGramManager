<%-- 
    ...
    Created on : Jun 22, 2020, 5:58:27 AM
    Author     : mac
--%>
...
<html dir="ltr" lang="en">
    ...
    <head>
        ...
        <title>FynGram Manager :: Order :: Details</title>
        <!-- Bootstrap css -->
    ...
    <body class="app sidebar-mini">
        ...
        <jsp:include page="../../../../WEB-INF/static_pages/users/sellers/order/orderdetails.jsp"></jsp:include>
