<%-- 
    ...
    Created on : Jun 15, 2020, 10:20:24 PM
    Author     : Pinky
--%>
...
<html dir="ltr" lang="en">
    ...
    <head>
        ...
        <title>FynGram Manager :: Transactions</title>
        <!-- Bootstrap css -->
  ...
  <link href="../../../../assets/plugins/sweet-alert/sweetalert.css" rel="stylesheet">
    ...
    <body class="app sidebar-mini">
        ...
        <jsp:include page="../../../../WEB-INF/static_pages/users/sellers/transaction/transaction.jsp"></jsp:include>
        ...
        <script src="../../../../assets/js/appscripts/transaction.js"></script>
