<%-- 
    Document   : dashboard
    Created on : Jun 15, 2020, 10:06:01 PM
    Author     : Pinky
--%>
...
<html dir="ltr" lang="en">
    ...
    <body class="app sidebar-mini">
        ...
        <jsp:include page="../../../../WEB-INF/static_pages/users/sellers/dashboard/dashboard.jsp"></jsp:include>
        ...
        <!--News Ticker js-->
        <script src="../../../../assets/plugins/newsticker/breaking-news-ticker.min.js"></script>
        <script src="../../../../assets/plugins/newsticker/newsticker.js"></script>
